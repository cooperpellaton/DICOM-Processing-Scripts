...
%         Off_t(RGN,:)=[OFFSET(1) OFFSET(15) OFFSET(29) OFFSET(43) OFFSET(57)]
        RGN=RGN+1
        On_mag(RGN,:) = [mean(On_m(1:14)) mean(On_m(15:28)) mean(On_m(29:42)) mean(On_m(43:56)) mean(On_m(57:70))]
        
    end
    
output(:,:)=On_t
output2(:,:)=Off_t
save('cluster_38POS_onsets.txt', 'output', '-ASCII')
save('cluster_38POS_offsets.txt', 'output2', '-ASCII')