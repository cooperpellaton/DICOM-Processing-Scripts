% This generates topographic maps for ERP data. Lots of input data, with very specific formatting.
% Email Josh (tremeljosh@gmail.com) if you need some help.
...
% Total # of electrodes (i.e., # columns in infile--NOT necessarily the # of electodes!)
max_elec = 137;
