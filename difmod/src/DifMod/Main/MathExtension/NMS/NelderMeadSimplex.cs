...
namespace DifMod {
	...
	public sealed class NelderMeadSimplex {
		/// <summary>
		/// Jitter to prevent floating point roundoff variance.
		/// </summary>
		private static readonly double JITTER = 1e-10d;
		...
		public static RegressionResult Regress ( SimplexConstant[] simplexConstants, double convergenceTolerance, int maxEvaluations,
			...
			RegressionResult regressionResult = new RegressionResult(
				terminationReason, vertices[errorProfile.LowestIndex].Components,
		...
		/// <summary> Contract the simplex uniformly around the lowest point. </summary>
		/// <param name="errorProfile"></param>
		/// <param name="vertices"></param>
		/// <param name="errorValues"></param>
