...
# REVISION HISTORY:
#----------------------------------------------------------------
# Revision 2.1: minor (current)
# 11.14.2011
#	added script to check raw directory structure and check for
#	data left over from previous or botched preprocessing run.
#
# Revision 2.0: major
# 10.04.2011	JT
...
# 07) Check institution tag in dcm header for different 
#    processing streams. Really, this would be for the flip on
#    the structs. Maybe, we can figure out the orientation flag,
